...
//
// The file upload uses the authenticated user's Supabase JWT. Server decides:
//   is_admin → import directly
//   not admin → queued in boardgamebuddy_pending_guides for admin review
    ...
    <div class="card bg-base-200 mb-3">
      <div class="card-body p-4">
        ...
        <p class="text-xs text-base-content/60">
          ...
          ${isAdmin
            ? "As an admin, your uploads are imported immediately."
            : "Non-admin uploads are queued for admin review before going live."}
        </p>
        ...
        <div class="flex gap-2 mt-2">
          <button id="import-guide-submit" class="btn btn-primary btn-sm" disabled>
            ...
            ${isAdmin ? "Import now" : "Submit for review"}
          </button>
        </div>
      </div>
    </div>
    ...
    ${isAdmin ? `
      <div class="card bg-base-200 mb-3">
        <div class="card-body p-4">
          ...
          <p class="text-xs text-base-content/60">Approve or reject guide bundles submitted by other users.</p>
