...
Trips can be **shared** with other travelers as a viewer or collaborator (invite → accept); on a shared trip every member sets their own **Vibe** on each place (booked / must-do / interested / could-skip) which rolls up into a group consensus, and each place shows who added it.
