...
│   ├── widgets/              — quick-paste, scrap-editor, trip-editor (edit name/destination/scope/dates), add-plans (from-Wander-List multi-select), trip-share (crew modal), anchor-editor, tutorial-carousel
