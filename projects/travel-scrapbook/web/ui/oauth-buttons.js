...
function renderOAuthButtons({ busy = false } = {}) {
  const dis = busy ? 'disabled' : '';
  return `
    <button type="button" class="auth-oauth-btn auth-oauth-google" onclick="handleOAuthSignIn('google')" ${dis}>
    ...
    <button type="button" class="auth-oauth-btn auth-oauth-apple" onclick="handleOAuthSignIn('apple')" ${dis}>
