// The real SauceBoss App. Kept separate from App.js so a module-load failure
// here gets caught and rendered onscreen by App.js's diagnostic boundary
// instead of producing the opaque "main not registered" error.
