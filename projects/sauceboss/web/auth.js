...
function renderAuthModal() {
  ...
  modal.innerHTML = `
    ...
    <div class="auth-modal__card" role="dialog" aria-modal="true" aria-label="Sign in">
      ...
      <button class="auth-oauth-btn auth-oauth-google" onclick="handleOAuthSignIn('google')" ${state.authBusy ? 'disabled' : ''}>
      ...
      <button class="auth-oauth-btn auth-oauth-apple" onclick="handleOAuthSignIn('apple')" ${state.authBusy ? 'disabled' : ''}>
